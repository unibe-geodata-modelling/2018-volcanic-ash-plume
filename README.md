...
Figure 6: World Map Output Eyjafjallajökull Simulation.
  <br>
  <br>
...
<img src="https://github.com/unibe-geodata-modelling/2018-volcanic-ash-plume/blob/Figures/EUROPEZOOM-gif.gif" width="900" height="500">
Figure 10: Europe Zoom: Transport and Diffusion-Type: All Directions.
  <br>
  <br>
  
  
  ### Figure Europe Flight Zones
  
  The last plot generated by our model accounts for the ash concentration risks for air traffic.
  We used here the concentration breaks defined by the Civil Aviation Authority (CAA).
  
  <img src="https://github.com/unibe-geodata-modelling/2018-volcanic-ash-plume/blob/master/FLIGHTZONE.gif" width="900" height="500">
Figure 11: Europe FlyZone: Transport and Diffusion-Type: All Directions.
  <br>
  <br>
